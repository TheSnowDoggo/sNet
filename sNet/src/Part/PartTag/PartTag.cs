...
public sealed class PartTag
{
    ...
    public Dictionary<string, CObj> Properties { get; } = [];
    ...
    private static CObj ParseValue(PartStream stream) => stream.Peek().Type switch
    {
    ...
    private static CVec2 ParseVec2(PartStream stream)
    {
        ...
        return new CVec2((Number)x, (Number)y);
    }
