...
public abstract class ArrayBase : CObj,
	IReadOnlyList<CObj>
{
	public ArrayBase() : base(TypeId.Array) { }
	...
	public virtual CObj this[int index]
	{
		get => Nil.Value;
		set { }
	}

	private CObj GetOrNil(int index)
	{
	...
	public abstract IEnumerator<CObj> GetEnumerator();
